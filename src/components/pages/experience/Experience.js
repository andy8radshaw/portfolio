...
export default function Experience({ isLightMode }) {
  return (
    <PageContainer>
      ...
      <p>Whilst working at Reach I have collaborated on a range of projects. As part of the User Journeys team I have been tasked with building and maintaining parts of large scale online publications across multiple platforms. Including Web, Accelerated Mobile Pages, Facebook Instant Articles, Apple News and AWS. As part of the Agile team I am used to collaborating and working in a team towards 2-week sprint goals. As part of this role I use JavaScript, Pug.JS, Express, Node.js & Java.</p>
      <hr/>
